...
@dataclass
class ControlNetBrushNetOutput(BaseOutput):
    """
...
class ControlNetBrushNetModel(ModelMixin, ConfigMixin):
    """
    A ControlNetBrushNet model.
    ...
    def forward(
    ...
    ) -> Union[ControlNetBrushNetOutput, Tuple[Tuple[torch.FloatTensor, ...], torch.FloatTensor]]:
        """
        The [`ControlNetBrushNetModel`] forward method.
        ...
        return ControlNetBrushNetOutput(
